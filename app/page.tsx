...
import { ArrowRight, ChevronRight, Code, Sparkle, Sparkles, Star, TrendingUp, Zap } from "lucide-react";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-purple-50 via-white to-indigo-50 overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative container mx-auto px-4 py-20 z-10 text-center">
        <motion.div
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join thousands of developers who are already building their future with BuildSpace
            </p>
            <SignUpButton mode="modal">
              <motion.div
                whileHover={{ scale: 1.05 }}
      ...
      {/* Footer */}
      <footer className="relative border-t border-gray-200 py-8 z-10 bg-white/50 "></footer>
