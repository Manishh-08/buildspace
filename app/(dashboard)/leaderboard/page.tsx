...
export default function LeaderboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Your Rank Card */}
      {currentUserRank && (
        <Card className="bg-linear-to-r from-purple-50 to-indigo-50 dark:from-purple-950/20 dark:to-indigo-950/20 border-purple-200 dark:border-purple-800">
              ...
              >
                <CardContent className="pt-6">
                  ...
                  <Avatar className="h-16 w-16 mx-auto mb-3">
                    ...
                    <AvatarFallback className="bg-linear-to-r from-purple-600 to-indigo-600 text-white text-lg">
